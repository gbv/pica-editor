...
import { pushScopeId, popScopeId, openBlock, createBlock, withModifiers, createVNode, withDirectives, vModelText, createCommentVNode, toDisplayString, withScopeId } from 'vue';
...
const _withId = /*#__PURE__*/withScopeId("data-v-5e36071d");

pushScopeId("data-v-5e36071d");
...
const _hoisted_5 = /*#__PURE__*/createVNode("span", { style: {"font-variant":"small-caps"} }, "ppn ", -1 /* HOISTED */);
...
const _hoisted_10 = /*#__PURE__*/createVNode("code", { class: "cm-comment" }, "$", -1 /* HOISTED */);
...
const render = /*#__PURE__*/_withId(function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("form", {
    class: "PicaEditor",
    onSubmit: _cache[3] || (_cache[3] = withModifiers($event => (_ctx.loadRecord(_ctx.inputPPN)), ["prevent"]))
  }, [
      ...
      createVNode("ul", null, [
        (_ctx.picabase && _ctx.dbkey)
          ? (openBlock(), createBlock("li", _hoisted_3, [
              createVNode("a", { href: _ctx.picabase }, toDisplayString(_ctx.dbkey), 9 /* TEXT, PROPS */, ["href"])
            ]))
          : createCommentVNode("v-if", true),
        (_ctx.ppn)
          ? (openBlock(), createBlock("li", _hoisted_4, [
              ...
              (_ctx.picabase)
                ? (openBlock(), createBlock("a", {
                    ...
                    createVNode("code", null, toDisplayString(_ctx.ppn), 1 /* TEXT */)
                  ], 8 /* PROPS */, ["href"]))
    ...
    createVNode("div", _hoisted_7, [
      (_ctx.field)
        ? (openBlock(), createBlock("code", _hoisted_8, toDisplayString(_ctx.field), 1 /* TEXT */))
        : createCommentVNode("v-if", true),
      (_ctx.subfield)
        ? (openBlock(), createBlock("span", _hoisted_9, [
            _hoisted_10,
            createVNode("code", _hoisted_11, toDisplayString(_ctx.subfield), 1 /* TEXT */)
          ]))
        : createCommentVNode("v-if", true)
    ])
  ], 32 /* HYDRATE_EVENTS */))
